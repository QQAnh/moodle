						...
						<ul class="nav navbar-nav">
							...
							<li<?php if (strpos('apc eaccelerator xcache phpmyadmin sqlitemanager phpliteadmin', $page) !== false) { ?> class="active dropdown"<?php } else { ?> class="dropdown" <?php } ?>>
								...
								<ul class="dropdown-menu">
                                    ...
                                    <?php else: ?>
                                        <li class="disabled"><a href="#">phpMyAdmin (<?php echo tr("needs PHP 5.5.x to 7.0.x"); ?>)</a></li>
                                    <?php endif; ?>
                                    
                                    <?php if(version_compare(PHP_VERSION, '5.2.0', '>=') and version_compare(PHP_VERSION, '5.4.0', '<')): ?>
                                        <li><a target="_blank" href="<?php echo "/SQLiteManager/"; ?>">SQLite Manager</a></li>
                                    <?php else: ?>
                                        <li class="disabled"><a href="#">SQLite Manager (<?php echo tr("needs PHP 5.2.x or 5.3.x"); ?>)</a></li>
                                    <?php endif; ?>
...
<?php } ?>                                                    
			...
			<footer style="margin-top:40px;">
				...
				<p>&copy; 2013 - 2017 <a href="http://www.appsolute.de">appsolute GmbH</a></p>
			</footer>
		</div><!-- /.container -->
