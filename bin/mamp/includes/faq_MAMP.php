                            ...
                            <dd><?php echo tr("Open the application Terminal and type:"); ?><br/>
                                <br/>
                                <code>/home/latfish/moodle/moodle/Library/bin/mysqladmin -u root -p password &lt;<?php echo tr("NEWPASSWORD"); ?>&gt;</code><br/>
                                <br/>
                                ...
                                <?php echo tr("You can change the password for phpMyAdmin in the file /home/latfish/moodle/moodle/bin/phpMyAdmin/config.inc.php."); ?>
                            </dd>
